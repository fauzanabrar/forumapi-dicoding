...
DomainErrorTranslator._directories = {
  ...
  'COMMENT_REPOSITORY.METHOD_NOT_IMPLEMENTED': new InvariantError('method tidak diimplementasikan'),
  'THREAD_REPOSITORY.METHOD_NOT_IMPLEMENTED': new InvariantError('method tidak diimplementasikan'),
  'USER_REPOSITORY.METHOD_NOT_IMPLEMENTED': new InvariantError('method tidak diimplementasikan'),
};
